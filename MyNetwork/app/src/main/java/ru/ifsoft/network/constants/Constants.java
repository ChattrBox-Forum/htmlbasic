...
public interface Constants {
    ...
    public static final String YOUTUBE_API_KEY = "AIzaSyAz8TvzJatmQZOyc3OTk";
    ...
    public static final String BILLING_KEY = "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAgn";
