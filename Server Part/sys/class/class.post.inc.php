...
class post extends db_connect
{
    ...
    public function edit($postId, $postText = "", $postImage = "", $feeling = 0)
    {
        $urlData = $postText;
        ...
        $stmt = $this->db->prepare("UPDATE posts SET feeling = (:feeling), post = (:postText), imgUrl = (:imgUrl), urlPreviewTitle = (:urlPreviewTitle), urlPreviewImage = (:urlPreviewImage), urlPreviewDescription = (:urlPreviewDescription), urlPreviewLink = (:urlPreviewLink), createAt = (:createAt) WHERE id = (:postId)");
        $stmt->bindParam(":postId", $postId, PDO::PARAM_INT);
