<?php
    ...
    $css_files = array("main.css", "my.css", "drawer.css", "tipsy.css");
                                        ...
                                        <span class="card-header">
                                            ...
                                            <div class="card-content">
                                                <span class="card-title">
                                                    All things Cascading Style
                                                    <b original-title="Verified account" class="verified"></b>
                                                    <span class="sub-title">likes you post</span>
                                                </span>
                                                <span class="card-date">343453456</span>
                                                <span class="card-username">@dmitry</span>
                                                <span class="card-counter blue">Seen</span>
                                                <span class="card-description"> All things Cascading Style Sheets. </span>
                                                <span class="card-action">
                                                    <span class="card-act neutral" href="#">Delete</span>
